...
//   if (!username_input.match(usernamePattern) || username_input.length < 2) {
//     return res.status(200).send({
//       success: false,
//       data: {
//         un_field: "Incorrect username format, please have at least 2 characters, no special characters and space allowed",
//         pw_field: "",
//         email_field: "",
//         message: ""
//       }
...
module.exports = { retrieveProfile, updateProfile, createGroup, getAllUser, updateUser, authUser, getAllGroup };
